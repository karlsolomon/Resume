...
\photo[64pt][2pt]{../photos/headshot_close.jpg}                       % optional, remove / comment the line if not wanted; '64pt' is the height the picture must be resized to, 2pt is the thickness of the frame around it (put it to 0pt for no frame) and 'picture' is the name of the picture file
...
\section{Experience}
    ...
    \begin{itemize}
      ...
      \item Implemented ISO 26262 compliant FSP drivers in Orin chipsets for DriveOS 6.
    \end{itemize}}
...
\section{Computer skills}
    \cvdoubleitem{\textbf{Lanuages}}{C, C++, Python, Bash, Java, C\#}{\textbf{Targets}}{Arm Cortex-M, RISC-V, iOS, Android}
    \cvdoubleitem{\textbf{SW Tools}}{Git, RTOS, JIRA, Jenkins, OpenCV}{\textbf{Peripherals}}{Camera, EEPROM, LED, Flash, GPS}
    \cvdoubleitem{\textbf{Protocols}}{UART, SPI, I\textsuperscript{2}C, USB, HDMI}{\textbf{Equipment}}{Logic Analyzer, Oscope, Solder Iron}
    ...
    % \cvskilllegend*[]{}% adjust post spacing
    ...
    % \cvskillplainlegend{}
    % \cvskillplainlegend[0.2em][Entry-Level, Rusty][Mid-Level, Regular Usage][Senior, Daily Usage][Deep Knowledge][Expert]{Legend}
    ...
    %% Example usages:
    % \cvskillentry*{Language:}{3}{Embedded C/C++}{6}{Core Comptency. Internet use rare. RTFM.}
    ...
    % \cvskillentry*{Technologies:}{3}{I2C/SPI/UART/HDMI/USB}{3}{}
    % \cvskillentry{}{2}{Cortex-M/RISCV/RTOS}{3}{}
